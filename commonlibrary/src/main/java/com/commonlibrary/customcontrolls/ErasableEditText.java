 ...
 */
public class ErasableEditText extends android.support.v7.widget.AppCompatEditText implements View.OnTouchListener, View.OnFocusChangeListener, TextWatcherAdapter.TextWatcherListener {
    ...
    public ErasableEditText(Context context, AttributeSet attrs, int defStyle) {
