...
public class StoragePermission extends ResourcePermission
{
    ...
    public StoragePermission(Activity context) {
        super(context);
    }
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        if (permissions != null && permissions.length > 0) {
                            ...
                            if (! showRationale) {
                                ...
                                Utils.getInstance().showDialog(getContext(), getContext().getString(R.string.storagepermission), getContext().getString(R.string.permission_needed_writestorage), getContext().getString(R.string.yes), getContext().getString(R.string.cancel1), new IDialogListener() {
                                    @Override
                                ...
                                Utils.getInstance().showDialog(getContext(), getContext().getString(R.string.storagepermission), getContext().getString(R.string.permission_denied_writestorage), getContext().getString(R.string.retry), getContext().getString(R.string.cancel1), new IDialogListener() {
                                    @Override
                                    public void onClickOk(boolean isok) {
                                        if(isok)
                                        {
