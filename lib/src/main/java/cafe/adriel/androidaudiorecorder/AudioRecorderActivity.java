...
//    ImageButton record,restart,play;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_clicked= (Button) findViewById(R.id.btn_clicked);
        ...
        if(Util.isBrightColor(color)) {
            ...
            ContextCompat.getDrawable(this, R.drawable.aar_ic_check).setColorFilter(Color.BLACK, PorterDuff.Mode.SRC_ATOP);
