...
public class AddTimeEntry extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spLeaveSubject3.setOnItemSelectedListener(AddTimeEntry.this);

        spLeaveSubject2= (Spinner) findViewById(R.id.spLeaveSubject2);
        spLeaveSubject2.setOnItemSelectedListener(AddTimeEntry.this);
...
//                    days_leave2.setText("");
        ...
        calculate_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d("Value4" ,""+value4 );                   //25.0
                Log.d("Perunitrate" ,""+Perunitrate );       //25.0
                Log.d("roundOff" ,""+roundOff );                   //25.0
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if(obj.optString("status").equals("success")){
                        ...
                        ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<String>(AddTimeEntry.this, simple_spinner_item,names2);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<String>(AddTimeEntry.this, simple_spinner_item,names3);
                            spinnerArrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item); // The drop down view
