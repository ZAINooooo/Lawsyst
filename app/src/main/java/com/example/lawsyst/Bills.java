...
public class Bills extends Fragment implements BillsAdapter.ContactsAdapterListener {


    public RecyclerView data_list;
    public BillsAdapter dataListAdapter;
    public ArrayList<Bills_Pojo> contactList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        dataListAdapter = new BillsAdapter(getActivity(), contactList, this);
