...
public class ExpandableListAdapters2 extends BaseExpandableListAdapter {
    ...
    public ExpandableListAdapters2(Context context, List<String> listDataHeader, HashMap<String, List<String>> listChildData, List<Integer> icons) {
...
//        lblListHeader.setTypeface(null, Typeface.BOLD);
        ...
        if (isExpanded) {
            linearLayout.setBackgroundColor(ContextCompat.getColor(_context, R.color.colorgolden));
        } else {
...
//
//            default:
//                lblListHeader.setCompoundDrawablesWithIntrinsicBounds(0, 0, isExpanded ? 0 : R.drawable.ic_add, 0);
//        }
//
//        return convertView;
//    }
